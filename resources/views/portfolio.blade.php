    ...
    <header>
        ...
        <nav>
            ...
            <a href="#work">Works</a>
            <button class="btn" onclick="location.href='#contact'">Get in touch</button>
        </nav>
    </header>
    ...
    <section class="contact" id="contact">
        ...
        <div class="contact-wrapper">
            ...
            <div class="contact-info">
                <h2>Let's Connect</h2>
                <p>If you’d like to collaborate, ask anything, or just say hi, feel free to message me. I’m always open for new opportunities!</p>

                <ul>
                    <li><strong>Email:</strong> rheapangan290@gmail.com</li>
                    <li><strong>Facebook:</strong> /rhealynpangan</li>
                    <li><strong>Instagram:</strong> @trexxxyz</li>
                </ul>
            </div>
